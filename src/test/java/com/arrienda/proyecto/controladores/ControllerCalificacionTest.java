...
public class ControllerCalificacionTest {
    ...
    public void testGetAllCalificaciones() throws Exception {
        ...
        when(controllerCalificacion.getAllCalificaciones()).thenReturn(calificaciones);
    ...
    public void testGetCalificacionById() throws Exception {
        ...
        when(controllerCalificacion.getCalificacionById(id)).thenReturn(calificacion);
    ...
    public void testgetCalificacionesArrendador() throws Exception {
        ...
        when(controllerCalificacion.getCalificacionesArrendador(1L)).thenReturn(calificacionesArrendador);
    ...
    public void testgetCalificacionesArrendatario() throws Exception {
        ...
        when(controllerCalificacion.getCalificacionesArrendatario(1L)).thenReturn(calificacionesArrendatario);
    ...
    public void testgetCalificacionesPropiedad() throws Exception {
        ...
        when(controllerCalificacion.getCalificacionesPropiedad(1L)).thenReturn(calificacionesPropiedad);
    ...
    public void testcrearCalificacion() throws Exception {
        ...
        when(controllerCalificacion.crearCalificacion(any(DTOCalificacion.class))).thenReturn(calificacion);
    ...
    public void testActualizarCalificacion() throws Exception {
        ...
        when(controllerCalificacion.actualizarCalificacion(eq(id), any(DTOCalificacion.class))).thenReturn(calificacion);
        ...
        verify(controllerCalificacion, times(1)).actualizarCalificacion(eq(id), any(DTOCalificacion.class));
    }

    @Test
    public void testEliminarCalificacion() throws Exception {
        Long id = 1L;
        when(controllerCalificacion.eliminarCalificacion(id))
        ...
        verify(controllerCalificacion, times(1)).eliminarCalificacion(id);
    }
    ...
    public void testEliminarCalificacionNotFound() throws Exception {
        Long id = 1L;
        when(controllerCalificacion.eliminarCalificacion(id))
                .thenThrow(new EntityNotFoundException("Calificación no encontrada"));
